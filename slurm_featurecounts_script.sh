...
featureCounts -T 12 -t exon -g gene_id -p --countReadPairs -a ./genome/Mus_musculus.GRCm38.102.gtf.gz -o ./quantification/ERR1755082_counts.txt ./mapped_reads/sorted_ERR1755082.bam
7

...
hisat2 --threads 12 -x /project/shared/resources/1_linux/genomes/Mus_musculus/Ensembl/GRCm38/Sequence/HISAT/mm10 -1 ./fastq/ERR1755082_1.fastq.gz \
-2 ./fastq/ERR1755082_2.fastq.gz --rna-strandness RF --summary-file mapped_reads/stats.txt -S mapped_reads/ERR1755082_mapped_reads_output.sam

...
samtools view --threads 12 -bh ./mapped_reads/ERR1755082_mapped_reads_output.sam > ./mapped_reads/ERR1755082.bam
samtools sort --threads 12 ./mapped_reads/ERR1755082.bam > ./mapped_reads/sorted_ERR1755082.bam
samtools index --threads 12 ./mapped_reads/sorted_ERR1755082.bam
